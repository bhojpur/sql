...
func (EngineTrigger) Descriptor() protoreflect.EnumDescriptor {
	return file_sql_proto_enumTypes[2].Descriptor()
}

func (EngineTrigger) Type() protoreflect.EnumType {
	return &file_sql_proto_enumTypes[2]
}
...
func (EnginePhase) Descriptor() protoreflect.EnumDescriptor {
	return file_sql_proto_enumTypes[3].Descriptor()
}

func (EnginePhase) Type() protoreflect.EnumType {
	return &file_sql_proto_enumTypes[3]
}
...
func (LogSliceType) Descriptor() protoreflect.EnumDescriptor {
	return file_sql_proto_enumTypes[4].Descriptor()
}

func (LogSliceType) Type() protoreflect.EnumType {
	return &file_sql_proto_enumTypes[4]
}
...
var file_sql_proto_rawDesc = []byte{
	0x0a, 0x09, 0x73, 0x71, 0x6c, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x02, 0x76, 0x31, 0x1a,
	...
	0x55, 0x4c, 0x54, 0x10, 0x06, 0x32, 0xa6, 0x04, 0x0a, 0x0a, 0x53, 0x71, 0x6c, 0x53, 0x65, 0x72,
	...
	0x6a, 0x70, 0x75, 0x72, 0x2f, 0x73, 0x71, 0x6c, 0x2f, 0x70, 0x6b, 0x67, 0x2f, 0x61, 0x70, 0x69,
...
var file_sql_proto_enumTypes = make([]protoimpl.EnumInfo, 5)
var file_sql_proto_msgTypes = make([]protoimpl.MessageInfo, 24)
...
var file_sql_proto_depIdxs = []int32{
	...
	5,  // 27: v1.SqlService.StartLocalEngine:input_type -> v1.StartLocalEngineRequest
	8,  // 28: v1.SqlService.StartFromPreviousEngine:input_type -> v1.StartFromPreviousEngineRequest
	7,  // 29: v1.SqlService.StartEngine:input_type -> v1.StartEngineRequest
	9,  // 30: v1.SqlService.ListEngines:input_type -> v1.ListEnginesRequest
	14, // 31: v1.SqlService.Subscribe:input_type -> v1.SubscribeRequest
	16, // 32: v1.SqlService.GetEngine:input_type -> v1.GetEngineRequest
	18, // 33: v1.SqlService.Listen:input_type -> v1.ListenRequest
	27, // 34: v1.SqlService.StopEngine:input_type -> v1.StopEngineRequest
	6,  // 35: v1.SqlService.StartLocalEngine:output_type -> v1.StartEngineResponse
	6,  // 36: v1.SqlService.StartFromPreviousEngine:output_type -> v1.StartEngineResponse
	6,  // 37: v1.SqlService.StartEngine:output_type -> v1.StartEngineResponse
	13, // 38: v1.SqlService.ListEngines:output_type -> v1.ListEnginesResponse
	15, // 39: v1.SqlService.Subscribe:output_type -> v1.SubscribeResponse
	17, // 40: v1.SqlService.GetEngine:output_type -> v1.GetEngineResponse
	19, // 41: v1.SqlService.Listen:output_type -> v1.ListenResponse
	28, // 42: v1.SqlService.StopEngine:output_type -> v1.StopEngineResponse
...
func file_sql_proto_init() {
	...
	file_sql_proto_msgTypes[14].OneofWrappers = []interface{}{
